...
import { getClassifiersLists } from "../services/classifierService";
import { paginate } from "../utils/paginate";
import ClassifierListsTrTable from "./classifierListsTrTable";
        ...
        <div className="row">
          <div className="col-3">
            <div className="p-3 border bg-light">
              <h5>Вложенная таблица</h5>
            </div>
          </div>
          <div className="col">
            <div className="p-3 border bg-light">
              <h5>Журнал учета входящих документов.</h5>
